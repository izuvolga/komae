...
## Directory-Based Project の利点

### 開発者体験
- **バージョン管理**: Gitなどでプロジェクトを追跡しやすい
- **デバッグ**: ファイル構造が見やすく、問題の特定が容易
- **外部ツール連携**: 他のエディタやツールでアセットを編集可能

### パフォーマンス
- **遅延読み込み**: 必要なアセットのみ読み込み
- **キャッシュ効果**: ファイルベースなのでOS/ブラウザキャッシュが効く
- **大容量対応**: ZIP展開・圧縮のオーバーヘッドなし

### ファイル管理
- **アセット管理**: assetsフォルダで画像やフォントを整理
- **相対パス**: プロジェクト内での相対パス参照が自然
- **部分的編集**: 特定のアセットだけを変更・差し替え可能

### 移植性とバックアップ
- **プロジェクト移動**: ディレクトリ全体をコピーするだけ
- **クラウド同期**: DropboxやGoogle Driveで自動同期
- **アーカイブ**: 必要に応じてZIP圧縮でアーカイブ化
